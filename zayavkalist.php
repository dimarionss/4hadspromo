...
<div class="container">
    <section class="logo">
        <a href="index.php" class="fa fa-angle-left arrow-left"></a>
    ...
    <? if ($_GET['offer'] == 1) { ?>
        <section class="offers">
            <div class="offer__one offborder">
                <h2 style="margin: 9.3px 0;">Абонемент</h2>
                <h2 style="margin: 9.3px 0;">1 месяц</h2>
        ...
        <section class="zayavka__text">
            <h3>Срок действия абонемента 45 дней, <br> с момента первого посещения</h3>
            <p>Укажите данные <br> владельца абонемента</p>
        </section>
    ...
    <? } elseif ($_GET['offer'] == 2) { ?>
        <section class="offers">
            <div class="offer__two offborder">
                <h2 style="margin: 9.3px 0;">Абонемент</h2>
                <h2 style="margin: 9.3px 0;">2 месяца</h2>
        ...
        <section class="zayavka__text">
            <h3>Срок действия абонемента 90 дней,<br>с момента первого посещения</h3>
            <p>Укажите данные <br> владельца абонемента</p>
        </section>
    ...
    <? } elseif ($_GET['offer'] == 3) { ?>
        ...
        <section class="offers">
            <div class="offer__three offborder">
                <h2 style="margin: 9.3px 0;">Абонемент</h2>
                <h2 style="margin: 9.3px 0;">3 месяца</h2>
        ...
        <section class="zayavka__text">
            <h3>Срок действия абонемента 120 дней,<br>с момента первого посещения</h3>
            <p>Укажите данные <br> владельца абонемента</p>
        </section>
    ...
    <section class="form__section">
        <form action="https://money.yandex.ru/eshop.xml" method="post">
            <input required name="sum" value="<?=$cost?>" type="hidden"/>
            <input required name="shopId" value="723845" type="hidden"/>
            <input required name="scid" value="1841196" type="hidden"/>
            <input required id="paymentType" name="paymentType" value="AC" type="hidden"/>
            <p>
                <input class="input" name="custName" type="text" placeholder="Имя и фамилия"/>
            </p>

            <p>
                <input class="input" name="customerNumber" type="tel" placeholder="Номер телефона"/>
            </p>

            <p>
                <input class="input" name="custEmail" type="email" placeholder="Электронная почта"/>
            </p>

            <p class="zayavka__text">Выберите филиал</p>
            <p>
                <select class="input" name="orderDetails">
                    <option>ТРЦ Аура</option>
                    <option>ТРЦ Ройал парк</option>
                    <option>ТРЦ Сибирский Молл</option>
                </select>
            </p>
            <div class="zayavka__text">
                <p>Выберите способ оплаты</p>
            </div>
            <div id="dd" class="wrapper-dropdown-1" tabindex="1">
                <div class="block__buttompay">
                    <div class="buttom__pay" onclick="$('#paymentType').val('AC');">Банковская карта</div>
                    <div class="buttom__pay" onclick="$('#paymentType').val('PC');">Яндекс.деньги</div>
                </div>
                <div id="dd" onclick="stateChange()" tabindex="1" class="buttom__select wrapper-dropdown-3"><a>Другие
                        способы <span class="fa fa-angle-down"></span></a></div>
                <div class="">
                    <ul id="dropdown" style="display : none" class="dropdown block__buttompay2">
                        <li class="buttom__pay" onclick="$('#paymentType').val('AC');">Apple Pay</li>
                        <li class="buttom__pay" onclick="$('#paymentType').val('AC');">Google Pay</li>
                        <li class="buttom__pay" onclick="$('#paymentType').val('WM');">WebMoney</li>
                        <li class="buttom__pay" onclick="$('#paymentType').val('QW');">Qiwi Кошелёк</li>
                    </ul>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Политика в отношении обработки персональных данных<br>
                        ...
                        посетителях (в т.ч. файлов «cookie») с помощью сервисов интернетстатистики (Яндекс Метрика и
